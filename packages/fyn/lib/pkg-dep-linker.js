...
class PkgDepLinker {
  ...
  async /*deprecated*/ linkAppFynRes(/*resData, fynFo, outputDir*/) {
  ...
  async /*deprecated*/ readAppFynRes(/*outputDir*/) {
    throw new Error("fyn resolutions deprecated.");
  ...
  //
  async /*deprecated*/ symlinkLocalPackage(/*fvDir, targetPath*/) {
  ...
  //
  async /*deprecated*/ saveLocalPackageFynLink(/*depInfo*/) {
  ...
  //
  async /*deprecated*/ loadLocalPackageAppFynLink(/*depInfo, fvDir*/) {
    throw new Error("symlink local package is deprecated, only hard linking.");
  }
